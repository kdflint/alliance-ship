...
INSERT INTO team (focus, name, visibility, task_manager_id) VALUES ('PythonDjango', 'Alliance Test Team', 'Private', 1);

INSERT INTO schedule (name) VALUES ('NorthBridge Standard');

INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 1', '2018-01-11', '2015-02-07', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 2', '2018-02-01', '2015-02-28', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 3', '2018-02-22', '2015-03-21', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 4', '2018-03-15', '2015-04-11', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 5', '2018-04-05', '2015-05-02', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 6', '2018-04-26', '2015-05-23', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 7', '2018-05-17', '2015-06-13', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 8', '2018-06-07', '2015-07-04', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 9', '2018-06-28', '2015-07-25', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 10', '2018-07-19', '2015-08-15', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 11', '2018-08-09', '2015-09-05', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 12', '2018-08-30', '2015-09-26', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 13', '2018-09-20', '2015-10-17', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 14', '2018-10-11', '2015-11-07', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 15', '2018-11-01', '2015-11-28', 1);
INSERT INTO event (name, start_dttm, end_dttm, schedule_id_fk) VALUES ('Sprint 16', '2018-11-22', '2015-12-19', 1);
